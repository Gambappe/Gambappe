 ...
 * is entered the hushed state latches through to reveal instead of flapping if a later tick
 * somehow lands back outside `isHushWindow` (e.g. a delayed `serverOffsetMs` correction).
 */
export function RevealHush({
  ...
  return (
    <div className={`relative ${className}`} data-testid="reveal-hush">
      ...
      <div className="relative mt-2 flex items-center gap-2" aria-live="polite">
        <span
          className="font-mono inline-block rounded border-2 px-2 py-0.5 text-xs font-bold tracking-widest uppercase"
